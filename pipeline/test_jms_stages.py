...
def test_jms_headers_origin_to_destination(sdc_builder, sdc_executor, jms, include_headers):
    ...
    try:
        ...
        connection.send(first_queue, message_data, persistent='false')
