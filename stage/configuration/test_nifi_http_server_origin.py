...
@stub
@pytest.mark.parametrize('stage_attributes', [{'flowfile_version': 'FLOWFILE_V1'},
                                              {'flowfile_version': 'FLOWFILE_V2'},
                                              {'flowfile_version': 'FLOWFILE_V3'}])
def test_flowfile_version(sdc_builder, sdc_executor, stage_attributes):
    pass
