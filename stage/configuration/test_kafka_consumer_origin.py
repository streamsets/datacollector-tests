...
def test_auto_offset_reset(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'auto_offset_reset': 'TIMESTAMP'}])
def test_auto_offset_reset_timestamp_in_ms(sdc_builder, sdc_executor, stage_attributes):
    pass
...
def test_include_timestamps(sdc_builder, sdc_executor, stage_attributes):
    pass
...
def test_key_capture_field(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@pytest.mark.parametrize('stage_attributes', [{'key_capture_mode': 'RECORD_HEADER'},
                                              {'key_capture_mode': 'RECORD_HEADER_AND_FIELD'}])
def test_key_capture_header_attribute(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@pytest.mark.parametrize('stage_attributes', [{'key_capture_mode': 'NONE'},
                                              ...
                                              {'key_capture_mode': 'RECORD_HEADER_AND_FIELD'}])
def test_key_capture_mode(sdc_builder, sdc_executor, stage_attributes):
    pass
...
def test_key_deserializer(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_rate_limit_per_partition_in_kafka_messages(sdc_builder, sdc_executor):
    pass
...
def test_value_deserializer(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_zookeeper_uri(sdc_builder, sdc_executor):
    pass
