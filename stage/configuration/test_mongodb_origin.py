...
@stub
@pytest.mark.parametrize('stage_attributes', [{'capped_collection': False}, {'capped_collection': True}])
def test_capped_collection(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_offset_field(sdc_builder, sdc_executor):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'offset_field_type': 'DATE'},
                                              {'offset_field_type': 'OBJECTID'},
                                              {'offset_field_type': 'STRING'}])
def test_offset_field_type(sdc_builder, sdc_executor, stage_attributes):
    pass
