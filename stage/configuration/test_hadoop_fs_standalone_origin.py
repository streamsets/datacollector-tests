...
@stub
def test_additional_configuration(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'file_post_processing': 'ARCHIVE'}])
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'file_post_processing': 'ARCHIVE'}])
def test_archive_retention_time_in_mins(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_batch_size_in_recs(sdc_builder, sdc_executor):
    pass
...
@stub
def test_buffer_limit_in_kb(sdc_builder, sdc_executor):
    pass
...
@stub
def test_configuration_files_directory(sdc_builder, sdc_executor):
    pass
...
@stub
def test_error_directory(sdc_builder, sdc_executor):
    pass
...
@stub
def test_file_system_uri(sdc_builder, sdc_executor):
    pass


@stub
def test_files_directory(sdc_builder, sdc_executor):
    pass
...
@stub
def test_impersonation_user(sdc_builder, sdc_executor):
    pass
...
@stub
def test_max_files_soft_limit(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'process_subdirectories': False, 'read_order': 'TIMESTAMP'},
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'read_order': 'LEXICOGRAPHICAL'}, {'read_order': 'TIMESTAMP'}])
def test_read_order(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_spooling_period_in_secs(sdc_builder, sdc_executor):
    pass
