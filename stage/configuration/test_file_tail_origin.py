...
@stub
@pytest.mark.parametrize('stage_attributes', [{'allow_late_directories': False}, {'allow_late_directories': True}])
def test_allow_late_directories(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'data_format': 'JSON'}, {'data_format': 'LOG'}, {'data_format': 'TEXT'}])
...
@stub
def test_file_to_tail(sdc_builder, sdc_executor):
    pass
...
@stub
def test_maximum_batch_size(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'data_format': 'LOG'}, {'data_format': 'TEXT'}])
def test_pattern_for_multiline(sdc_builder, sdc_executor, stage_attributes):
    pass
