...
@stub
def test_additional_headers(sdc_builder, sdc_executor):
    pass
...
def test_authority(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_connect_timeout_in_secs(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'emit_defaults': False}, {'emit_defaults': True}])
def test_emit_defaults(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'insecure': False, 'use_tls': True}, {'insecure': True, 'use_tls': True}])
def test_insecure(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_keep_alive_time_in_secs(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'method_type': 'SERVER_STREAMING_RPC'}, {'method_type': 'UNARY_RPC'}])
def test_method_type(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'method_type': 'UNARY_RPC'}])
...
@stub
def test_request_data(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'use_tls': True}])
def test_server_name(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_service_method(sdc_builder, sdc_executor):
    pass
