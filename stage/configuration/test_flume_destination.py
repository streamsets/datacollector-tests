...
@stub
@pytest.mark.parametrize('stage_attributes', [{'backoff': False, 'client_type': 'AVRO_LOAD_BALANCING'},
                                              {'backoff': True, 'client_type': 'AVRO_LOAD_BALANCING'}])
def test_backoff(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'client_type': 'AVRO_FAILOVER'},
                                              {'client_type': 'AVRO_LOAD_BALANCING'},
                                              {'client_type': 'THRIFT'}])
def test_client_type(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_flume_batch_size_in_events(sdc_builder, sdc_executor):
    pass


@stub
def test_flume_client_connection_timeout_in_ms(sdc_builder, sdc_executor):
    pass


@stub
def test_flume_client_request_timeout_in_ms(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'client_type': 'AVRO_LOAD_BALANCING',
                                               'host_selection_strategy': 'RANDOM'},
                                              {'client_type': 'AVRO_LOAD_BALANCING',
                                               'host_selection_strategy': 'ROUND_ROBIN'}])
def test_host_selection_strategy(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_hosts_configuration(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'client_type': 'AVRO_LOAD_BALANCING'}])
def test_max_backoff_in_ms(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_max_retry_attempts(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'one_event_per_batch': False}, {'one_event_per_batch': True}])
def test_one_event_per_batch(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_retry_wait_time_in_ms(sdc_builder, sdc_executor):
    pass
