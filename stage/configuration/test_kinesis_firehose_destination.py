...
@stub
@pytest.mark.parametrize('stage_attributes', [{'data_format': 'DELIMITED'}, {'data_format': 'JSON'}])
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'destination_type': 'EXISTING'}])
def test_destination_type(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_maximum_record_size_in_kb(sdc_builder, sdc_executor):
    pass
