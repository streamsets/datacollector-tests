...
@stub
def test_connection_string_key(sdc_builder, sdc_executor):
    pass
...
@stub
def test_container_name(sdc_builder, sdc_executor):
    pass
...
@stub
def test_event_hub_name(sdc_builder, sdc_executor):
    pass


@stub
def test_event_processor_prefix(sdc_builder, sdc_executor):
    pass
...
@stub
def test_namespace_name(sdc_builder, sdc_executor):
    pass
...
@stub
def test_shared_access_policy_name(sdc_builder, sdc_executor):
    pass
...
@stub
def test_storage_account_key(sdc_builder, sdc_executor):
    pass


@stub
def test_storage_account_name(sdc_builder, sdc_executor):
    pass
