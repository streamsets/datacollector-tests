...
@stub
def test_max_batch_request_size_in_kb(sdc_builder, sdc_executor):
    pass
...
@stub
def test_rpc_id(sdc_builder, sdc_executor):
    pass


@stub
def test_rpc_listening_port(sdc_builder, sdc_executor):
    pass
