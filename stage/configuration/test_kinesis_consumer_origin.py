...
@stub
@pytest.mark.parametrize('stage_attributes', [{'initial_position': 'AT_TIMESTAMP'},
                                              {'initial_position': 'LATEST'},
                                              {'initial_position': 'TRIM_HORIZON'}])
def test_initial_position(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'initial_position': 'AT_TIMESTAMP'}])
def test_initial_timestamp(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_read_interval_in_ms(sdc_builder, sdc_executor):
    pass
...
@stub
def test_tags(sdc_builder, sdc_executor):
    pass
...
@stub
def test_throttle_max_retries(sdc_builder, sdc_executor):
    pass


@stub
def test_throttle_wait_time(sdc_builder, sdc_executor):
    pass
