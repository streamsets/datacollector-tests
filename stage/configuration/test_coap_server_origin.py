...
@stub
def test_coap_listening_port(sdc_builder, sdc_executor):
    pass
...
@stub
def test_network_configuration(sdc_builder, sdc_executor):
    pass
...
@stub
def test_resource_name(sdc_builder, sdc_executor):
    pass
