...
@stub
def test_additional_client_configuration(sdc_builder, sdc_executor):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_app_id(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'auto_delete': False}, {'auto_delete': True}])
def test_auto_delete(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'automatic_recovery_enabled': False},
                                              {'automatic_recovery_enabled': True}])
def test_automatic_recovery_enabled(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_bindings(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_content_encoding(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_content_type(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_correlation_id(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_declaration_properties(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'delivery_mode': 'NON_PERSISTENT', 'set_amqp_message_properties': True},
                                              {'delivery_mode': 'PERSISTENT', 'set_amqp_message_properties': True}])
def test_delivery_mode(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'durable': False}, {'durable': True}])
def test_durable(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'exclusive': False}, {'exclusive': True}])
def test_exclusive(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True, 'set_expiration': True}])
def test_expiration(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_handshake_timeout_in_ms(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_headers(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_heartbeat_timeout_in_secs(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'mandatory': False}, {'mandatory': True}])
def test_mandatory(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_maximum_channel_number(sdc_builder, sdc_executor):
    pass


@stub
def test_maximum_frame_size_in_bytes(sdc_builder, sdc_executor):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_message_id(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}, {'data_format': 'PROTOBUF'}])
def test_message_type(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_name(sdc_builder, sdc_executor):
    pass


@stub
def test_network_recovery_interval(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'priority': 'EIGHT', 'set_amqp_message_properties': True},
                                              {'priority': 'FIVE', 'set_amqp_message_properties': True},
                                              {'priority': 'FOUR', 'set_amqp_message_properties': True},
                                              {'priority': 'NINE', 'set_amqp_message_properties': True},
                                              {'priority': 'ONE', 'set_amqp_message_properties': True},
                                              {'priority': 'SEVEN', 'set_amqp_message_properties': True},
                                              {'priority': 'SIX', 'set_amqp_message_properties': True},
                                              {'priority': 'THREE', 'set_amqp_message_properties': True},
                                              {'priority': 'TWO', 'set_amqp_message_properties': True},
                                              {'priority': 'ZERO', 'set_amqp_message_properties': True}])
def test_priority(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_reply_to(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': False},
                                              {'set_amqp_message_properties': True}])
def test_set_amqp_message_properties(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True, 'set_current_time': False},
                                              {'set_amqp_message_properties': True, 'set_current_time': True}])
def test_set_current_time(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True, 'set_expiration': False},
                                              {'set_amqp_message_properties': True, 'set_expiration': True}])
def test_set_expiration(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_shutdown_timeout_in_ms(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True, 'set_current_time': False}])
def test_time_stamp(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'set_amqp_message_properties': True}])
def test_user_id(sdc_builder, sdc_executor, stage_attributes):
    pass
