...
@stub
@pytest.mark.parametrize('stage_attributes', [{'batch_enabled': False}, {'batch_enabled': True}])
def test_batch_enabled(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_default_delay_threshold_in_ms(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'limit_exceeded_behaviour': 'BLOCK'},
                                              {'limit_exceeded_behaviour': 'IGNORE'},
                                              {'limit_exceeded_behaviour': 'THROW_EXCEPTION'}])
def test_limit_exceeded_behaviour(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_max_outstanding_message_count(sdc_builder, sdc_executor):
    pass


@stub
def test_max_outstanding_request_bytes(sdc_builder, sdc_executor):
    pass
...
@stub
def test_messages_count_threshold(sdc_builder, sdc_executor):
    pass
...
@stub
def test_request_bytes_threshold(sdc_builder, sdc_executor):
    pass
...
@stub
def test_topic_id(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'data_format': 'PROTOBUF', 'write_delimiter': False},
                                              {'data_format': 'PROTOBUF', 'write_delimiter': True}])
def test_write_delimiter(sdc_builder, sdc_executor, stage_attributes):
    pass
