...
@stub
def test_consumer_tag(sdc_builder, sdc_executor):
    pass
...
@stub
@pytest.mark.parametrize('stage_attributes', [{'one_record_per_message': False}, {'one_record_per_message': True}])
def test_one_record_per_message(sdc_builder, sdc_executor, stage_attributes):
    pass
