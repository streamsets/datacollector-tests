...
def test_add_unsupported_fields(sdc_builder, sdc_executor, stage_attributes):
    pass
...
@stub
def test_poll_interval(sdc_builder, sdc_executor):
    pass


@stub
def test_query_timeout(sdc_builder, sdc_executor):
    pass
...
def test_remove_replication_slot_on_close(sdc_builder, sdc_executor, stage_attributes):
    pass


@stub
def test_replication_slot(sdc_builder, sdc_executor):
    pass
...
def test_start_lsn(sdc_builder, sdc_executor, stage_attributes):
    pass
