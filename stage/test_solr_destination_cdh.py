...
@solr
def test_solr_write_records_cdh(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_records_on_error_discard(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_records_on_error_to_error(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_records_indexing_error_to_error(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_records_error_stop_pipeline(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_record_empty_stop_pipeline(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_record_empty_to_error(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_write_record_empty_discard(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_test_validations_null_url(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_test_validations_empty_fields(sdc_builder, sdc_executor, solr):
...
@solr
def test_solr_test_validations_invalid_url(sdc_builder, sdc_executor, solr):
