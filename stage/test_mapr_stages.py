...
def test_mapr_fs_origin_simple(data_collector, cluster):
    ...
    mapr_fs_origin >> sdc_rpc_destination
    mapr_fs_pipeline = builder.build(title='MapR FS pipeline')
    ...
    data_collector.add_pipeline(mapr_fs_pipeline, snapshot_pipeline)
    ...
    try:
        ...
        data_collector.start_pipeline(mapr_fs_pipeline).wait_for_finished()
