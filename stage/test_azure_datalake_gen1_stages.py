...
def test_adls_gen1_file_event_filepath_when_whole_file_mode_disabled(sdc_builder, sdc_executor, azure):
    ...
    try:
        ...
        dl_fs.mkdir(f'/{directory_name}')
        dl_fs.put(file_name, f'/{directory_name}/_tmp_sdc_0')
...
@azure('datalake')
def test_adls_gen1_file_event_filepath_when_whole_file_mode_enabled(
    ...
    try:
        ...
        dl_fs.mkdir(f'/{directory_name}')
        dl_fs.put(file_name, f'/{directory_name}/_tmp_sdc-output')
