...
DATA_TYPES_POSTGRESQL = [
    ...
    ('interval', "INTERVAL '18H 25M 32S'", 'STRING', '0 years 0 mons 0 days 18 hours 25 mins 32.0 secs'),
    ('interval', "INTERVAL '10h 10m 10s'", 'STRING', '0 years 0 mons 0 days 10 hours 10 mins 10.0 secs'),
    ('interval', "INTERVAL '4h 20m' - INTERVAL '30m'", 'STRING', '0 years 0 mons 0 days 3 hours 50 mins 0.0 secs'),
    ('interval', "INTERVAL '6 months ago'", 'STRING', '0 years -6 mons 0 days 0 hours 0 mins 0.0 secs'),
    ('interval', "180 * INTERVAL '2 minute'", 'STRING', '0 years 0 mons 0 days 6 hours 0 mins 0.0 secs'),
...
def test_data_format(sdc_builder, sdc_executor, database, keep_data):
    pytest.skip("JDBC MultiTable Origin doesn't deal with data formats")
